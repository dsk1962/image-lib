//TODO this is a copy of original code that fixes a bug. Remove if switch to newer version of boxable  

/*
 * Fixed bug in drawRow method. Bookmark creation code moved after page break validation
 * After fix in new version this class should be removed    
 */
...
public abstract class Table<T extends PDPage> {
    ...
    private void drawRow(Row<T> row) throws IOException {
        ...
        // BUG FIX book mark creation moved after page break test
